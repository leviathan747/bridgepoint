 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtuml.bp.xtext.masl.impl.ReturnTypeImpl#getTypeReference <em>Type Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReturnTypeImpl extends MinimalEObjectImpl.Container implements ReturnType
{
  ...
  {
    return MaslPackage.Literals.RETURN_TYPE;
  }
  ...
  public NotificationChain basicSetTypeReference(typeReference newTypeReference, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MaslPackage.RETURN_TYPE__TYPE_REFERENCE, oldTypeReference, newTypeReference);
  ...
  public void setTypeReference(typeReference newTypeReference)
  {
    if (newTypeReference != typeReference)
    {
      ...
      if (typeReference != null)
        msgs = ((InternalEObject)typeReference).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MaslPackage.RETURN_TYPE__TYPE_REFERENCE, null, msgs);
      if (newTypeReference != null)
        msgs = ((InternalEObject)newTypeReference).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MaslPackage.RETURN_TYPE__TYPE_REFERENCE, null, msgs);
      msgs = basicSetTypeReference(newTypeReference, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MaslPackage.RETURN_TYPE__TYPE_REFERENCE, newTypeReference, newTypeReference));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MaslPackage.RETURN_TYPE__TYPE_REFERENCE:
